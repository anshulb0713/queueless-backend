...
export const openapiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      TokenRequest: { type: 'object', required: ['branchId', 'serviceId'], properties: { branchId: { type: 'string', format: 'uuid', description: 'Only one unresolved token is allowed per customer at a branch.' }, serviceId: { type: 'string', format: 'uuid' }, fcmToken: { type: 'string', nullable: true, description: 'Optional FCM registration token saved before the token is created.' } } },
